...
import {
  ...
  RelayHandle,
  set_config_provider,
} from "@alexandria/relay_selector";
import { getConfigValue } from "../relay_selector/relay_config_provider.ts";
...
export async function fetchEventWithFallback(
  ...
  // TODO: Avoid duplicate work by setting this up once and checking whether it is already
  // available before invoking the setup function.
  set_config_provider(getConfigValue);

...
<div class="flex flex-col space-y-4">
      ...
      <div class="flex items-start space-x-3">
        ...
        <div class="flex-1">
          ...
          <p class="text-sm text-red-700 dark:text-red-300 mb-3">
            You're using a publication format (document title with <code>=</code
            >
            or "index card"). This editor is for individual notes only. Use the
            <a
      ...
      <div class="flex items-start space-x-3">
        ...
        <div class="flex-1">
          ...
          <p class="text-sm text-blue-700 dark:text-blue-300 mb-3">
            This editor is for creating individual notes (30041 events) only.
            Each section becomes a separate note event. You can add metadata
            like author, version, publication date, summary, and tags using
            AsciiDoc attributes. To create structured publications with a 30040
            index event that ties multiple notes together, use the <a
              href="/events?kind=30040"
  ...
  <div
    class="flex flex-col lg:flex-row lg:space-x-4 {showPreview
      ? 'lg:h-96'
      : ''}"
  >
    <!-- Editor Panel -->
    <div class="{showPreview ? 'lg:w-1/2' : 'w-full'} flex flex-col space-y-4">
      <div class="flex-1">
        <Textarea
          ...
          {placeholder}
          class="h-full min-h-64 resize-none {hasPublicationHeader
    ...
    {#if showPreview && !hasPublicationHeader}
      <div
        class="lg:w-1/2 lg:border-l lg:border-gray-200 lg:dark:border-gray-700 lg:pl-4 mt-4 lg:mt-0"
      >

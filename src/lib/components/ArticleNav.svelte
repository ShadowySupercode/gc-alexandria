...
<nav class="Navbar navbar-leather flex fixed top-[60px] sm:top-[76px] w-full min-h-[70px] px-2 sm:px-4 py-2.5 z-10 transition-transform duration-300 {isNavVisible ? 'translate-y-0' : '-translate-y-full'}">
  <!-- ... rest of the code ... -->
</nav> 
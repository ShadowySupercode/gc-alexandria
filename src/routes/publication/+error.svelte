<script lang="ts">
  ...
  function parseErrorMessage(message: string): {
    ...
    return {
      ...
      searchUrl,
      shortIdentifier:
        baseMessage.length > 50
          ? baseMessage.substring(0, 47) + "..."
          : baseMessage,
    };
  }

  $: errorInfo = page.error?.message
    ? parseErrorMessage(page.error.message)
    : {
        errorType: "unknown",
        identifier: "",
        shortIdentifier: "",
  ...
  <Alert class="border-l-4 border-red-500 bg-red-50 dark:bg-red-900/20">
    ...
    <div class="bg-gray-100 dark:bg-gray-800 rounded-lg p-4 mb-4">
      <div class="flex items-start space-x-2">
        <span
          class="text-sm font-medium text-gray-600 dark:text-gray-400 min-w-0"
        >
          Error Type:
        </span>
      ...
      <div class="flex items-start space-x-2 mt-2">
        ...
        <div class="flex-1 min-w-0">
          <div
            class="text-sm text-gray-800 dark:text-gray-200 font-mono break-all"
          >
          ...
          {#if errorInfo.identifier.length > 50}
            <details class="mt-2">
              ...
              <div
                class="mt-2 text-xs text-gray-600 dark:text-gray-400 font-mono break-all"
              >

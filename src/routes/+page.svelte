<script lang="ts">
  ...
  function handleEventCountUpdate(counts: {
    displayed: number;
    total: number;
  }) {
    eventCount = counts;
...
<Modal bind:open={showClearSearchModal} size="md">
  <div class="p-6">
    ...
    <div class="flex justify-end gap-3">
      <Button color="light" onclick={cancelClearSearch}>Cancel</Button>
      <Button color="primary" onclick={confirmClearSearch}>Clear Search</Button>
    </div>
  </div>
</Modal>
